...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    text: '«Показать в Finder» или «Скопировать ⌘C» — и картинка уже в макете. Корзина с отменой на случай промаха.',
  ...
  return (
    <section id="order" className="mx-auto max-w-[1200px] px-6 pb-[140px] md:px-10 xl:px-0">
      ...
      <Reveal index={2}>
        ...
        >
          Папки и подпапки, свободные теги, поиск по ⌘K, защита от дублей и быстрый выход в работу.
          Библиотека, которая не требует ритуалов.
        </p>
      </Reveal>
